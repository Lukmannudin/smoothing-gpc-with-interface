...
class FilterMinSize:
    ...
    def psnrResult(self):
        #open result
        img_result_path = self.baseUrl +'imageresults/result_min.jpg'
    ...
    def main(self):
        ...
        #run filter
        filter_size = 3
        removed_noise = self.min_filter(img1, filter_size)

        #save image
        im_result_path = self.baseUrl +'imageresults/result_min.jpg'
